...
| Item | Valor |
|------|--------|
| Versão do sistema | 0.18.2 — Play e foto da visita na VPS |
| Última atualização | 15/09/2026 — GPS do Play não trava; foto da visita comprime e envia sem esperar GPS |
...
Ver `docs/CHANGELOG.md` (atual: **v0.18.2**).
