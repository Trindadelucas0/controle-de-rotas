...
| Item | Valor |
|------|--------|
| Versão do sistema | 0.18.1 — Câmera do odômetro e marcos na visita |
| Última atualização | 14/09/2026 — Tirar foto abre a câmera; Porteira/Ponte/… também após o Cheguei |
...
Ver `docs/CHANGELOG.md` (atual: **v0.18.1**).
