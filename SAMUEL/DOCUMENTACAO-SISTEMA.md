...
| Item | Valor |
|------|--------|
| Versão do sistema | 0.20.0 — Custos da frota |
| Última atualização | 17/09/2026 — abastecimentos, dashboard REAL/ESTIMADO, odômetro histórico |
...
Ver `docs/CHANGELOG.md` (atual: **v0.20.0**).
