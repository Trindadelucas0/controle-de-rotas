...
| Item | Valor |
|------|--------|
| Versão do sistema | 0.21.2 — Publicar missão de gravar acima da barra no PWA |
| Última atualização | 25/09/2026 — botão da aba Gravar preso acima da bottom nav no celular |
...
Ver `docs/CHANGELOG.md` (atual: **v0.21.2**).
